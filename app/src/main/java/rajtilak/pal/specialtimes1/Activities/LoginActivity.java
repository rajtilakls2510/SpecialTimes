...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signInButton=findViewById(R.id.signBtn);
        mprog=findViewById(R.id.progressLogin);
    ...
    private void signIn() {
        Log.d(TAG, "signIn: SignIn Button Pressed");
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                Log.d(TAG, "onActivityResult: Authenticating With Firebase");
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if(user!=null)
        {
            Log.d(TAG, "updateUI: Directing to MainActivity");
